...
- La variable `dep`, tiene los puntajes de depresión de la escala de Escala de Detección Depresión Infantil de Birleson (EDIB) (Birleson et al., 1987). Esta escala varía de 0 a 36 puntos. En Chile, se emplea como punto de corte a los 19 puntos. Con este criterio, se indica que personas jóvenes con 19 o más puntos podrían tener depresión.
...
- Considerando los resultados anteriores. Aproximadamente, ¿cuántos jóvenes podrían tener depresión?

## Ejercicio 8. Recodificación y Proporción.

- **¿Qué proporción de casos tiene depresión?**

- Empleando al valor 19 como criterio de corte clasifique a todos los casos con y sin depresion.
...
- Una vez realizada la recodificación, calcule la proporción de casos en cada categoria.
...
- Similares a las expectativas anterioes, se plantea que la prevalencia de depresión es mayor en mujeres. Calcule una tabla de contigencia, donde se obtenga la proporción de mujeres y de hombres, respectivamente, que se encuentra por sobre el puntaje de corte empleado en Chile (19 puntos o más).
